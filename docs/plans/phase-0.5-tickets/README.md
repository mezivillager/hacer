...
**Gap analysis:** [`docs/nand2tetris/project1/gap-analysis.md`](../../nand2tetris/project1/gap-analysis.md)
...
|----------------|--------|------------------|-------------|
| **Pure modules** (P05-01, P05-04–07, P05-15, P05-18) | Required (new tests) | **Regression only** — full suite must stay green | Optional unless UI ships |
...
**Parser bundle (P05-04–07):** Parsers are not on the React tree by default. If policy demands browser-level verification beyond Vitest, add a **dev-only** `window.__HACER_PARSE_SMOKE__` (or similar) in `main.tsx` guarded by `import.meta.env.DEV` and a thin `e2e/specs/**` file — optional for Layer 0; otherwise Vitest + green store E2E is sufficient.
...
| [P05-07](P05-07.md) | Curriculum data bundle | 4h | GAP-3D-4 | TODO |
...
| [P05-19](P05-19.md) | Curriculum navigation UI | 8h | P05-07, P05-01 | GAP-3D-7 | TODO |
...
LAYER 0 (no deps)
  P05-01  ChipRegistry ──► P05-15 (builtins), P05-16 (compiler), P05-18 (hierarchy),
                           P05-19 (curriculum UI), P05-20 (chip def panel)
  ...
  P05-07  Curriculum data ─► P05-19 (curriculum UI)
...
LAYER 2
  ...
  P05-19  Curriculum UI        [P05-07, P05-01]
...
| 6 | P05-07, P05-08 | 0 | Data bundle + node rename, can pair |
...
| 15 | P05-19, P05-20 | 2 | Curriculum UI + chip def panel |
