...
const shortcutCategories: ShortcutCategory[] = [
  ...
  },
  {
    ...
    shortcuts: [
      ...
      { keys: ["B"], description: "Box select mode" },
    ],
  },
  {
    name: "Editing",
  ...
  },
  {
    ...
    shortcuts: [
      ...
      { keys: ["G"], description: "Grab/move mode" },
    ],
  },
  {
    name: "Tools",
    shortcuts: [
      ...
      { keys: ["I"], description: "Add input" },
      { keys: ["O"], description: "Add output" },
      { keys: ["J"], description: "Add junction" },
    ],
  },
  {
    name: "Simulation",
