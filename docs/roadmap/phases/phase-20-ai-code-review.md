  ...
  private async generateAIReview(review: PullRequestReview): Promise<AIReview> {
    ...
    const response = await this.openai.chat.completions.create({
      ...
      messages: [
        {
          role: 'system',
          content: `You are an expert senior software engineer conducting a thorough code review for HACER, a circuit design platform built with React, TypeScript, Node.js, and modern web technologies.
...
export class GitHubIntegration {
  ...
  private formatReviewBody(review: PullRequestReview): string {
    ...
    body += `---\n`;
    body += `*This review was generated by HACER's AI Code Review Agent. `;
