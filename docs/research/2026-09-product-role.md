...
- **One evaluator is not a panel.** Averaged over six projects, "single evaluators found only 35 percent of the usability problems"; about five evaluators, "certainly at least three", find roughly 75% [S3]. Current NN/g practice: three to five people evaluate independently, then synthesize; "heuristic evaluations cannot replace user research" [S4] — H.
