/**
 * Multi-bit values as text and back: binary, decimal or hex at a given width. Pure — no React, no
 * DOM — so it lives in the engine layer and every caller imports it downward: `signalDisplay`
 * beside it, and the UI (`MultiBitInput`) from above (#180).
 */
